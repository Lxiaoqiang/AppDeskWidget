...
class WidgetSlot3Receiver : GlanceAppWidgetReceiver() {

    companion object {
        private const val TAG = "WidgetSlot3Receiver"
        private const val SLOT_INDEX = 3
    }
    ...
    override fun onEnabled(context: Context) {
        ...
        Log.d(TAG, "onEnabled - First Slot 3 widget added")
        WidgetAnimationWorker.enqueue(context.applicationContext)
    }

    override fun onDisabled(context: Context) {
        super.onDisabled(context)
        Log.d(TAG, "onDisabled - Last Slot 3 widget removed")
