...
class WidgetSlot1Receiver : GlanceAppWidgetReceiver() {

    companion object {
        private const val TAG = "WidgetSlot1Receiver"
        private const val SLOT_INDEX = 1
    }
    ...
    override fun onEnabled(context: Context) {
        ...
        Log.d(TAG, "onEnabled - First Slot 1 widget added")
        WidgetAnimationWorker.enqueue(context.applicationContext)
    }

    override fun onDisabled(context: Context) {
        super.onDisabled(context)
        Log.d(TAG, "onDisabled - Last Slot 1 widget removed")
