...
class WidgetSlot6Receiver : GlanceAppWidgetReceiver() {

    companion object {
        private const val TAG = "WidgetSlot6Receiver"
        private const val SLOT_INDEX = 6
    }
    ...
    override fun onEnabled(context: Context) {
        ...
        Log.d(TAG, "onEnabled - First Slot 6 widget added")
        WidgetAnimationWorker.enqueue(context.applicationContext)
    }

    override fun onDisabled(context: Context) {
        super.onDisabled(context)
        Log.d(TAG, "onDisabled - Last Slot 6 widget removed")
